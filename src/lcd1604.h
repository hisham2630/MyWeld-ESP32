 ...
 *
 * Drives an HD44780-compatible 4-line × 16-character LCD via I2C
 * backpack (PCF8574). Only compiled when DISPLAY_TYPE == DISPLAY_LCD_1604.
 *
 ...
 * @param row   0–3
 * @param text  Up to 16 characters
 */
